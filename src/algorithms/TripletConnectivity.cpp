...
TripletConnectivity::TripletConnectivity(clever::context & ctext) :
    m_ctx(ctext),
    tripletConnectivityWide2(ctext),
...
void TripletConnectivity::run(TrackletCollection  const &trackletsInitial,
                              TrackletCollection &trackletsFollowing,
                              bool iterateBackwards, bool tightPacking) const
{
    cl_mem intialHits1;
    cl_mem intialHits2;
