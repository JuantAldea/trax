...
class PHit : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_position(::PB_Event::PGlobalPoint* position);
...
inline float PGlobalPoint::x() const {
  // @@protoc_insertion_point(field_get:PB_Event.PGlobalPoint.x)
  return x_;
}
inline void PGlobalPoint::set_x(float value) {
  set_has_x();
  x_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PGlobalPoint.x)
}
...
inline float PGlobalPoint::y() const {
  // @@protoc_insertion_point(field_get:PB_Event.PGlobalPoint.y)
  return y_;
}
inline void PGlobalPoint::set_y(float value) {
  set_has_y();
  y_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PGlobalPoint.y)
}
...
inline float PGlobalPoint::z() const {
  // @@protoc_insertion_point(field_get:PB_Event.PGlobalPoint.z)
  return z_;
}
inline void PGlobalPoint::set_z(float value) {
  set_has_z();
  z_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PGlobalPoint.z)
}
...
inline const ::PB_Event::PGlobalPoint& PHit::position() const {
  // @@protoc_insertion_point(field_get:PB_Event.PHit.position)
  return position_ != NULL ? *position_ : *default_instance_->position_;
}
inline ::PB_Event::PGlobalPoint* PHit::mutable_position() {
  set_has_position();
  if (position_ == NULL) position_ = new ::PB_Event::PGlobalPoint;
  // @@protoc_insertion_point(field_mutable:PB_Event.PHit.position)
  return position_;
}
...
inline void PHit::set_allocated_position(::PB_Event::PGlobalPoint* position) {
  delete position_;
  position_ = position;
  if (position) {
    set_has_position();
  ...
  // @@protoc_insertion_point(field_set_allocated:PB_Event.PHit.position)
}
...
inline ::PB_Event::DetectorType PHit::detectortype() const {
  // @@protoc_insertion_point(field_get:PB_Event.PHit.detectorType)
  return static_cast< ::PB_Event::DetectorType >(detectortype_);
}
inline void PHit::set_detectortype(::PB_Event::DetectorType value) {
  assert(::PB_Event::DetectorType_IsValid(value));
  set_has_detectortype();
  detectortype_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PHit.detectorType)
}
...
inline ::google::protobuf::uint64 PHit::layer() const {
  // @@protoc_insertion_point(field_get:PB_Event.PHit.layer)
  return layer_;
}
inline void PHit::set_layer(::google::protobuf::uint64 value) {
  set_has_layer();
  layer_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PHit.layer)
}
...
inline ::google::protobuf::uint64 PHit::detectorid() const {
  // @@protoc_insertion_point(field_get:PB_Event.PHit.detectorId)
  return detectorid_;
}
inline void PHit::set_detectorid(::google::protobuf::uint64 value) {
  set_has_detectorid();
  detectorid_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PHit.detectorId)
}
...
inline ::google::protobuf::uint64 PHit::hitid() const {
  // @@protoc_insertion_point(field_get:PB_Event.PHit.hitId)
  return hitid_;
}
inline void PHit::set_hitid(::google::protobuf::uint64 value) {
  set_has_hitid();
  hitid_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PHit.hitId)
}
...
inline ::google::protobuf::uint64 PHit::simtrackid() const {
  // @@protoc_insertion_point(field_get:PB_Event.PHit.simTrackID)
  return simtrackid_;
}
inline void PHit::set_simtrackid(::google::protobuf::uint64 value) {
  set_has_simtrackid();
  simtrackid_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PHit.simTrackID)
}
...
inline float PHit::simtrackpt() const {
  // @@protoc_insertion_point(field_get:PB_Event.PHit.simTrackPt)
  return simtrackpt_;
}
inline void PHit::set_simtrackpt(float value) {
  set_has_simtrackpt();
  simtrackpt_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PHit.simTrackPt)
}
...
inline ::google::protobuf::uint64 PEvent::runnumber() const {
  // @@protoc_insertion_point(field_get:PB_Event.PEvent.runNumber)
  return runnumber_;
}
inline void PEvent::set_runnumber(::google::protobuf::uint64 value) {
  set_has_runnumber();
  runnumber_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PEvent.runNumber)
}
...
inline ::google::protobuf::uint64 PEvent::lumisection() const {
  // @@protoc_insertion_point(field_get:PB_Event.PEvent.lumiSection)
  return lumisection_;
}
inline void PEvent::set_lumisection(::google::protobuf::uint64 value) {
  set_has_lumisection();
  lumisection_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PEvent.lumiSection)
}
...
inline ::google::protobuf::uint64 PEvent::eventnumber() const {
  // @@protoc_insertion_point(field_get:PB_Event.PEvent.eventNumber)
  return eventnumber_;
}
inline void PEvent::set_eventnumber(::google::protobuf::uint64 value) {
  set_has_eventnumber();
  eventnumber_ = value;
  // @@protoc_insertion_point(field_set:PB_Event.PEvent.eventNumber)
}
...
inline const ::PB_Event::PHit& PEvent::hits(int index) const {
  // @@protoc_insertion_point(field_get:PB_Event.PEvent.hits)
  return hits_.Get(index);
}
inline ::PB_Event::PHit* PEvent::mutable_hits(int index) {
  // @@protoc_insertion_point(field_mutable:PB_Event.PEvent.hits)
  return hits_.Mutable(index);
}
inline ::PB_Event::PHit* PEvent::add_hits() {
  // @@protoc_insertion_point(field_add:PB_Event.PEvent.hits)
  return hits_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::PB_Event::PHit >&
PEvent::hits() const {
  // @@protoc_insertion_point(field_list:PB_Event.PEvent.hits)
  return hits_;
}
inline ::google::protobuf::RepeatedPtrField< ::PB_Event::PHit >*
PEvent::mutable_hits() {
  // @@protoc_insertion_point(field_mutable_list:PB_Event.PEvent.hits)
  return &hits_;
}
...
inline const ::PB_Event::PEvent& PEventContainer::events(int index) const {
  // @@protoc_insertion_point(field_get:PB_Event.PEventContainer.events)
  return events_.Get(index);
}
inline ::PB_Event::PEvent* PEventContainer::mutable_events(int index) {
  // @@protoc_insertion_point(field_mutable:PB_Event.PEventContainer.events)
  return events_.Mutable(index);
}
inline ::PB_Event::PEvent* PEventContainer::add_events() {
  // @@protoc_insertion_point(field_add:PB_Event.PEventContainer.events)
  return events_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::PB_Event::PEvent >&
PEventContainer::events() const {
  // @@protoc_insertion_point(field_list:PB_Event.PEventContainer.events)
  return events_;
}
inline ::google::protobuf::RepeatedPtrField< ::PB_Event::PEvent >*
PEventContainer::mutable_events() {
  // @@protoc_insertion_point(field_mutable_list:PB_Event.PEventContainer.events)
  return &events_;
}
...
template <> struct is_proto_enum< ::PB_Event::DetectorType> : ::google::protobuf::internal::true_type {};
template <>
